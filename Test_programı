...
Soru Gelecek
	...
	test1A = tk.Button(test1p,text="A)\t \t",bg=reng0070,command = test1a)
	test1A.pack()

	test1B = tk.Button(test1p,text="B)\t \t",bg=reng0070,command = test1b)
	test1B.pack()

	test1C = tk.Button(test1p,text="C)\t \t",bg=reng0070,command = test1c)
	test1C.pack()

	test1D = tk.Button(test1p,text="D)\t \t",bg=reng0070,command = test1d)
	test1D.pack()

	test1E = tk.Button(test1p,text="E)\t \t",bg=reng0070,command = test1e)
	test1E.pack()
